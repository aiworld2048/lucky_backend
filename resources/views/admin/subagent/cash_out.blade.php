            ...
            <div class="card col-lg-6 offset-lg-3 col-md-6 offset-md-3 col-sm-8 offset-sm-2 col-10 offset-1" style="border-radius: 15px;">
                <div class="card-header">
                    <div class="card-title col-12">
                        <h5 class="d-inline fw-bold">Withdraw from Sub-Agent</h5>
                        <a href="{{ route('admin.subagent.index') }}" class="btn btn-primary float-right">
                            <i class="fas fa-arrow-left" style="font-size: 20px;"></i> Back
                        </a>
                    </div>
                </div>
                <form action="{{route('admin.subagent.makeCashOut', $subAgent->id)}}" method="POST">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-lg-12 offset-lg-0 col-md-6 offset-md-3 col-sm-8 offset-sm-2 col-10 offset-1">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" value="{{$subAgent->name}}" readonly>
                                </div>
                                <div class="form-group">
