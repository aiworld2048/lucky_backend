            ...
            <div class="row mb-2">
                <div class="col-sm-12">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">create Sub-Agent</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="card  col-lg-6 offset-lg-3 col-md-6 offset-md-3 col-sm-8 offset-sm-2 col-10 offset-1"
                ...
                <div class="card-header">
                    <div class="card-title col-12">
                        ...
                        <a href="{{ route('admin.subagent.index') }}" class="btn btn-primary d-inline float-right">
                        ...
                        <div class="row">
                            <div class="col-lg-12 offset-lg-0 col-md-6 offset-md-3 col-sm-8 offset-sm-2 col-10 offset-1">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="user_name" value="{{ $subagent_name }}"
                                        readonly>
                                    @error('user_name')
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="text-muted">Enter commission in percentage (0-100)</span>
                                    @error('commission')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
...
@section('script')
    ...
    <div>
        ...
        function copyToClipboard(button) {
            ...
            var referral_code = $(button).data('referral_code');
