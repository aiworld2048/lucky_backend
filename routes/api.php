...
use App\Http\Controllers\Api\V1\gplus\Webhook\WagerListController;
...
Route::get('operators/wagers', [WagerListController::class, 'index']);
Route::get('operators/wallet-balance', [WagerListController::class, 'walletBalance']);
Route::get('operators/{wagerCode}/game-history', [WagerListController::class, 'gameHistory']);
Route::get('operators/wagers/{idOrCode}', [WagerListController::class, 'show']);
