...
class AgentController extends Controller
{
    ...
    public function index(): View
    {
        ...
        // Get all agents (only Owner has access to this page via permissions)
        $users = User::with(['roles', 'children.buffaloPlayer'])
    ...
    public function store(AgentRequest $request): RedirectResponse
    {
        ...
        return redirect()->route('admin.agent.index')
            ...
            ->with('link', "https://blog.silentforestnature.xyz/login");
    }
